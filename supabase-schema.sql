...
-- =============================================
-- 촬영 가이드 (Shooting Guide)  -- 상세는 shooting-guide-schema.sql 참고
-- =============================================
...
CREATE POLICY "Public can view shooting guide storage" ON storage.objects
  FOR SELECT TO anon, authenticated USING (bucket_id = 'shooting-guides');
CREATE POLICY "Authenticated can upload shooting guide storage" ON storage.objects
  FOR INSERT TO authenticated WITH CHECK (bucket_id = 'shooting-guides');
CREATE POLICY "Authenticated can update shooting guide storage" ON storage.objects
  FOR UPDATE TO authenticated USING (bucket_id = 'shooting-guides') WITH CHECK (bucket_id = 'shooting-guides');
CREATE POLICY "Authenticated can delete shooting guide storage" ON storage.objects
  FOR DELETE TO authenticated USING (bucket_id = 'shooting-guides');
