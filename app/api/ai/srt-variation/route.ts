...
아래 원본 대본을 참고하여 비슷한 스타일과 구조로 베리에이션 대본 6개를 만들어주세요.
...
=== 출력 형식 ===
각 베리에이션마다 다음 형식으로 출력하세요:

---
[베리에이션 1]
(대본 내용)

[변경 포인트] 원본 대비 무엇이 어떻게 바뀌었는지 간단히 설명
...
이런 식으로 총 6개의 베리에이션을 만들어주세요.
각 베리에이션은 서로 다른 방식으로 변형해주세요 (톤 변경, 강조점 변경, 표현 변경 등).`
