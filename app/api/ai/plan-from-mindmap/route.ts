...
- **왜 이렇게 기획했는지(근거)를 반드시 함께 적어라.** 마인드맵의 잘한점/못한점/세그먼트와 우리 브랜드 브리프 중 무엇을 근거로 그 선택을 했는지 드러나게.
- 다음 구조의 마크다운으로 작성:
  ## 한 줄 컨셉
  ## 타겟 세그먼트  ← 마인드맵의 세그먼트 1·2를 모두 반영(누구에게/왜 이 타겟인지)
  ## 핵심 소구점
  ## 기획 의도·근거  ← 경쟁 소재의 어떤 점(잘한점/못한점)과 우리 브랜드 강점을 근거로 이 방향을 잡았는지 3~5줄
  ## 후킹(0~3초)  — 각 항목 끝에 "→ 근거: …" 한 줄
  ## 전개  — 각 항목 끝에 "→ 근거: …" 한 줄
  ## CTA  — "→ 근거: …" 한 줄
  ## 대본(나레이션 초안, 구간별)
  ## 촬영 메모
