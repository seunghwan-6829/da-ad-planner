...
- phases: 소재를 흐름 구간으로 나눔(4~6개). 영상이면 시간 흐름, 이미지면 시선·정보 흐름. 각 weight는 대략적 비중(전부 합쳐 100). desc는 25자 이내.
  ⚠️ 각 구간의 name은 반드시 "서로 다른 단계"로 분배할 것. 누구나 바로 이해되는 쉬운 한국어로. 후보: 시선 끌기(후킹) / 문제 제기 / 정보·비밀 공개 / 근거·증명 / 후기·반응 / 제품 사용 장면 / 혜택·가격 강조 / 구매 유도(CTA). 어려운 마케팅 전문용어(예: '상품 실증', '사회적 증거')는 쓰지 말 것. 절대 모든 구간을 '후킹'으로 만들지 말 것.
